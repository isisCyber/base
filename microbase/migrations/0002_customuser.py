    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_level', models.CharField(choices=[('Utilisateur', 'Utilisateur'), ('Modérateur', 'Modérateur'), ('Administrateur', 'Administrateur')], default='Utilisateur', max_length=50)),
